...
import com.example.vincent.whynot.UI.Pagers.EventViewPager;
import com.example.vincent.whynot.UI.Fragments.EventsFragment;
import com.example.vincent.whynot.UI.Fragments.MapsFragment;
import com.example.vincent.whynot.UI.Other.SlidingTabLayout;
import com.example.vincent.whynot.UI.Adapters.ViewPagerAdapter;
...
public class MainActivity extends AppCompatActivity implements EventsFragment.EventsFragmentListener {
    ...
    private static final CharSequence TITLES[] = {"Events", "Map", "Watchlist"};
...
//        });
    ...
    public void refreshToolbar(){
        System.out.println("Testing: pager item " + pager.getCurrentItem());
        if(pager.getCurrentItem() == 1) {
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
            getSupportActionBar().setTitle("Near you");
            animateViewOut(toolbar.findViewById(R.id.action_maps));
            animateViewIn(toolbar.findViewById(R.id.action_watchlist));//menu.findItem(R.id.action_maps).setVisible(false);
        } else if(pager.getCurrentItem() == 0) {
            getSupportActionBar().setDisplayHomeAsUpEnabled(false);
            getSupportActionBar().setTitle("Events");
            animateViewIn(toolbar.findViewById(R.id.action_maps));
            animateViewIn(toolbar.findViewById(R.id.action_watchlist));//menu.findItem(R.id.action_maps).setVisible(true);
        } else if(pager.getCurrentItem() == 2){
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
            getSupportActionBar().setTitle("Watchlist");
            animateViewIn(toolbar.findViewById(R.id.action_maps));
            animateViewOut(toolbar.findViewById(R.id.action_watchlist));//menu.findItem(R.id.action_maps).setVisible(true);
        }
    }
    ...
    public void updateWatchlist(){
        adapter.updateWatchlist();
        App.app.getPreferencesManager().saveWatchlist();
    }
   ...
   /** Start an intent to send an SMS. **/
    ...
    /** Only end the activity if you are on the events list tab, if you are on the maps tab or the watchlist
     * tab, return to the events list tab. **/
    @Override
